...
--coalesce([AOA],0) as [AOA],	coalesce([AOR],0) as [AOR],	coalesce([AOM],0) as [AOM],	coalesce([AOK],0) as [AOK], 'BestSectorSPDR' as DataSet
,Price, ePrice, tid, 'BestSectorSPDR' as DataSet
from (
